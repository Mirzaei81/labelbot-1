...
def create_Invoice(data):
    ...
    draw.text((2140,420), f"{convert(data['address'])}", fill='black',anchor="rm", font=font)
    ...
    draw.text((1850,805), f"{data['product_discount1']}{convert('%')}", fill='black',anchor="mm", font=font2)
    draw.text((1850,900), f"{data['product_discount2']}{convert('%')}", fill='black',anchor="mm", font=font2)
    draw.text((1850,995), f"{data['product_discount3']}{convert('%')}", fill='black',anchor="mm", font=font2)
    draw.text((1850,1080), f"{data['product_discount4']}{convert('%')}", fill='black',anchor="mm", font=font2)
    draw.text((1500,805), f"{data['product_price1']}{convert('T')}", fill='black',anchor="mm", font=font2)
    draw.text((1500,900), f"{data['product_price2']}{convert('T')}", fill='black',anchor="mm", font=font2)
    draw.text((1500,995), f"{data['product_price3']}{convert('T')}", fill='black',anchor="mm", font=font2)
    draw.text((1500,1080), f"{data['product_price4']}{convert('T')}", fill='black',anchor="mm", font=font2)
    ...
    draw.text((2180,1225), f"{profit}{convert('T')}", fill='black',anchor="mm", font=font2)
    draw.text((2180,1305), f"{total_dis}{convert('T')}", fill='black',anchor="mm", font=font2)
    draw.text((2180,800), f"{dtprice1}{convert('T')}", fill='black',anchor="mm", font=font2)
    draw.text((2180,900), f"{dtprice2}{convert('T')}", fill='black',anchor="mm", font=font2)
    draw.text((2180,990), f"{dtprice3}{convert('T')}", fill='black',anchor="mm", font=font2)
    draw.text((2180,1080), f"{dtprice4}{convert('T')}", fill='black',anchor="mm", font=font2)
