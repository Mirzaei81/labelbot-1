...
def create_label(data):
    ...
    draw.text((800,1600), f"{convert(data['product_name3'])}", fill='black',anchor="mm", font=font2)
    ...
    draw.text((800,2320), f"{convert(data['product_name7'])}", fill='black',anchor="mm", font=font2)
    draw.text((800,2500), f"{convert(data['product_name8'])}", fill='black',anchor="mm", font=font2)
    ...
    draw.text((2130,1600), f"{data['product_discount3']}{convert("%")}", fill='black',anchor="mm", font=font2)
    ...
    draw.text((2130,2320), f"{data['product_discount7']}{convert("%")}", fill='black',anchor="mm", font=font2)
    draw.text((2130,2500), f"{data['product_discount8']}{convert("%")}", fill='black',anchor="mm", font=font2)
    ...
    draw.text((1700,1600), f"{format_number(data['product_price3'])}{convert("T")}", fill='black',anchor="mm", font=font2)
    ...
    draw.text((1700,2320), f"{format_number(data['product_price7'])}{convert("T")}", fill='black',anchor="mm", font=font2)
    draw.text((1700,2500), f"{format_number(data['product_price8'])}{convert("T")}", fill='black',anchor="mm", font=font2)
    ...
    draw.text((1300,1600), f"{data['qty3']}", fill='black',anchor="mm", font=font2),
    ...
    draw.text((1300,2320), f"{data['qty7']}", fill='black',anchor="mm", font=font2),
    draw.text((1300,2500), f"{data['qty8']}", fill='black',anchor="mm", font=font2),
    ...
    draw.text((2600,3120), f"{format_number(profit)}{convert("T")}", fill='black',anchor="mm", font=font2)
    draw.text((2600,3270), f"{format_number(total_dis)}{convert("T")}", fill='black',anchor="mm", font=font2)
    ...
    draw.text((2600,1600), f"{format_number(dtprice3)}{convert("T")}", fill='black',anchor="mm", font=font2)
    ...
    draw.text((2600,2320), f"{format_number(dtprice7)}{convert("T")}", fill='black',anchor="mm", font=font2)
    draw.text((2600,2500), f"{format_number(dtprice8)}{convert("T")}", fill='black',anchor="mm", font=font2)
